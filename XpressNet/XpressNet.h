...
class XpressNetClass
{
  ...
  public:
	...
	void start(uint8_t XAdr, int XControl);  //Initialisierung Serial
  ...
  private:
	...
	void sendSchaltinfo(bool schaltinfo, byte data1, byte data2);  //Aufbereiten der Schaltinformation
